...
async function test() {
  ...
  try {
    ...
    console.log('HTML snippet:', res.body.substring(0, 1500));
    
    // Look for API endpoints in script tags or variables
    const matches = res.body.match(/api_[a-zA-Z0-9_]+|api_url|apiUrl|API_URL/gi) || [];
    console.log('API keyword matches:', matches);
  } catch (err) {
